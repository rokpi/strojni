import os
import argparse
from my_utils.utils_new import model_to_str, getAngle, create_directory, get_all_filepaths
from tqdm import tqdm
import numpy as np
from pathlib import Path
import pandas as pd
from my_utils.utils import preproc_img
import tensorflow as tf
from my_utils.utils_exceptions import encoder_layer

def argparser():
    parser = argparse.ArgumentParser()
    parser.add_argument('--models_dir', default=r'/home/rokp/test/models', type=str, help='Path to the hdf5 file')
